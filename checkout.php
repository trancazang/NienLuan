...
<form action="" method="post">
   ...
   <div class="cart-items">
      ...
      ?>
      <p><span class="name"><?= $fetch_cart['name']; ?></span><span class="price"><?= number_format($fetch_cart['price'],0,"","."); ?> x <?= number_format($fetch_cart['quantity'],0,"","."); ?>VNĐ</span></p>
      <?php
            }
         }else{
      ...
      ?>
      <p class="grand-total"><span class="name">Tổng cộng:</span><span class="price"><?= number_format($grand_total,0,"","."); ?>VNĐ</span></p>
   ...
   <div class="user-info">
      ...
      <p><i class="fas fa-map-marker-alt"></i><span><?php if($fetch_profile['address'] == ''){echo 'Hãy nhập địa chỉ giao hàng';}else{echo $fetch_profile['address'];} ?></span></p>
